...
export const recipes: Recipe[] = [
  ...
  {
    id: "5-minute-personal-tortilla-pizza",
    title: "5 Minute Personal Tortilla Pizza",
    category: CATEGORIES.ENTREES,
    imageExtension: "jpg",
    servings: "2",
    ...
    ingredients: [
      "*2 8\" or 10\" whole wheat flour tortillas",
      "1/2 cup pizza or pasta sauce, divided",
  ...
  {
    id: "ultimate-breakfast-casserole",
    ...
    time: "45 minutes",
    directions: [
      "Preheat the oven to 350 degrees, and spray a non-stick 9 x 13 pan.",
      "Chop and dice all vegetables.",
      "In a bowl, crack 6 eggs and add the milk, and then whisk together.",
      "Add the diced vegetables to the egg mixture, and mix until everything is evenly incorporated.",
      "Pour mixture into pan, and sprinkle cheese on top. Place in oven, and bake for 20-25 minutes.",
      "Remove casserole and let cool for 5 minutes. Serve and enjoy.",
    ],
    ingredients: [
      "*1 cup shredded cheddar cheese",
      "*6 eggs",
  ...
  {
    id: "chocolate-peanut-butter-sundae-smoothie",
    title: "Chocolate Peanut Butter Sundae Smoothie",
    category: CATEGORIES.BREAKFAST,
    imageExtension: "webp",
    servings: 4,
    source: "Food Network",
    ...
    directions: [
      ...
      "Pour into 4 glasses and drizzle with some extra syrup.",
    ],
    ingredients: [
  ...
  {
    id: "quick-and-easy-banana-muffins",
    title: "Quick and Easy Banana Muffins",
    category: CATEGORIES.BREAKFAST,
    imageExtension: "jpg",
    servings: "10-12",
    source: "Food Network",
    time: "30 minutes",
    directions: [
      "Preheat oven to 425°F (218°C). Spray a 12-count muffin tin with nonstick spray or use cupcake liners.",
  ...
  },
  {
    ...
    time: "15 minutes",
    directions: [
      "Boil pasta according to package directions. Drain, reserving 1/2 cup of pasta water for later use. ",
      "Saute onion, garlic, and carrots in olive oil over medium heat for approximately 2 minutes. Add broccoli and peppers, and sauté 2 minutes more. Add squash, spinach, and any other vegetables until softened. Add tomatoes and Italian seasoning, and blend well. Turn off heat. ",
      "In a large bowl or pot, add the sautéed vegetables to the drained pasta. Add lemon juice and small amounts of pasta water, if needed, to loosen the pasta. ",
      "Toss with fresh parsley and parmesan cheese.",
      "Serve and enjoy!",
    ],
    ingredients: [
      "*Whole wheat penne pasta (or shape of choice)",
      "1 tbsp olive oil",
      "*4 cups fresh veggies, chopped (carrots, broccoli, bell pepper, zucchini, squash, spinach, tomatoes, or any others)",
      "2 tsp dried Italian seasoning",
      "*2 tablespoons fresh lemon juice",
      "*2 tbsp fresh chopped parsley",
      "1/2 cup shredded parmesan or Italian blend cheese",
    ]
  },
  {
    id: "black-bean-taco-salad",
    title: "Black Bean Taco Salad",
    category: CATEGORIES.SALADS,
    imageExtension: "jpg",
    servings: 4,
  ...
  },
  {
    ...
    time: "15 minutes",
    directions: [
      "In a small mixing bowl break up the tuna with a fork. Toss with the celery, onion and parsley. Add the mayonnaise, and mustard and season with pepper, to taste. Stir to combine. Add lemon juice, to taste, if using."
    ],
    ingredients: [
  ...
  },
  {
    ...
    directions: [
      ...
      "Combine tuna, mayonnaise, celery, onion, parsley, and vinegar in a bowl; season with salt and black pepper.",
      "Place bread on a baking sheet; broil in the preheated oven until lightly toasted, 1 minute. Remove from oven; keep broiler on.",
      "Divide tuna salad among bread slices; place 1 cheese slice on top of each. Layer each with 2 tomato slices; top each with 1 cheese slice.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "*7 ounces canned white tuna, packed in water, drained",
  ...
  },
  {
    ...
    directions: [
      "Combine yogurt with sweetener, vanilla, and salt in a bowl and mix until incorporated.",
      "Line baking sheet with parchment paper and spread yogurt mix. If you want a thicker bark, do not spread it very thin.",
      "Add toppings to bark, sprinkling evenly over top.",
      "Set in freezer for at least 3 hours to set.",
      "Cut or break up bark and place in freezer safe dish or bag for up to a week.",
    ],
    ingredients: [
      "*2 cups of Greek yogurt, or yogurt of choice",
  ...
  },
  {
    ...
    directions: [
      ...
      "Heat oil in a small pan and sauté the tuna, stirring often, until the tuna is heated through and very slightly browned. Take the pan off the heat.",
      "Heat a griddle over high heat and place them on it. Heat the tortillas, turning once or twice in the process, until they are very hot. For hard taco shells, place them on a baking sheet and heat until crispy.",
  ...
  {
    id: "shredded-tofu-wrap",
    title: "Shredded Tofu Wrap",
    category: CATEGORIES.SANDWICHES,
    imageExtension: "jpg",
    servings: "4",
    source: "Plant You",
